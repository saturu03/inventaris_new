...
import { index, edit, update } from '@/routes/deposits';
...
export default function DepositEdit({
    ...
    const {
        ...
        depositor_phone: deposit.depositor_phone || '',
        deposit_date: deposit.deposit_date || '',
        estimated_pickup_date: deposit.estimated_pickup_date || '',
        notes: deposit.notes || '',
        items: deposit.items.length > 0
